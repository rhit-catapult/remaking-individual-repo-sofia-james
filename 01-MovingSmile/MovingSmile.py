    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if pressed_keys[pygame.K_UP]:
                #move the eyes when this happens
                eye_y = eye_y + 5
        ...
        pygame.draw.circle(screen, (0, 0, 0), (242+eye_x, 162-eye_y), 10)  # black pupil

        pygame.draw.circle(screen, (225, 225, 225), (400, 160), 25)  # white eye
        pygame.draw.circle(screen, (0, 0, 0), (400, 160), 25, 3)  # black outline
        pygame.draw.circle(screen, (0, 0, 0), (398+eye_x, 162-eye_y), 10)  # black pupil
